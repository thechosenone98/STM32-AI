...
#ifndef AI_ANOMALYDETECTOR_H
#define AI_ANOMALYDETECTOR_H
#pragma once
...
/******************************************************************************/
#define AI_ANOMALYDETECTOR_MODEL_NAME          "anomalydetector"
#define AI_ANOMALYDETECTOR_ORIGIN_MODEL_NAME   "anomaly_detection"

/******************************************************************************/
#define AI_ANOMALYDETECTOR_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_ANOMALYDETECTOR_IN_NUM        (1)
#define AI_ANOMALYDETECTOR_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 25, 3, 1, 1, NULL), \
}
#define AI_ANOMALYDETECTOR_IN_SIZE { \
  AI_ANOMALYDETECTOR_IN_1_SIZE, \
}
#define AI_ANOMALYDETECTOR_IN_SIZE_BYTES { \
  AI_ANOMALYDETECTOR_IN_1_SIZE_BYTES, \
}
#define AI_ANOMALYDETECTOR_IN_1_HEIGHT      (25)
#define AI_ANOMALYDETECTOR_IN_1_WIDTH       (3)
#define AI_ANOMALYDETECTOR_IN_1_CHANNEL     (1)
#define AI_ANOMALYDETECTOR_IN_1_SIZE        (25 * 3 * 1)
#define AI_ANOMALYDETECTOR_IN_1_SIZE_BYTES  (AI_ANOMALYDETECTOR_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_ANOMALYDETECTOR_OUT_NUM       (1)
#define AI_ANOMALYDETECTOR_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 4, 1, NULL), \
}
#define AI_ANOMALYDETECTOR_OUT_SIZE { \
  AI_ANOMALYDETECTOR_OUT_1_SIZE, \
}
#define AI_ANOMALYDETECTOR_OUT_SIZE_BYTES { \
  AI_ANOMALYDETECTOR_OUT_1_SIZE_BYTES, \
}
#define AI_ANOMALYDETECTOR_OUT_1_HEIGHT      (1)
#define AI_ANOMALYDETECTOR_OUT_1_WIDTH       (1)
#define AI_ANOMALYDETECTOR_OUT_1_CHANNEL     (4)
#define AI_ANOMALYDETECTOR_OUT_1_SIZE        (1 * 1 * 4)
#define AI_ANOMALYDETECTOR_OUT_1_SIZE_BYTES  (AI_ANOMALYDETECTOR_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_ANOMALYDETECTOR_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup anomalydetector
 ...
 * @ref ai_anomalydetector_create. Both the activations memory buffer 
 ...
 * using @ref ai_anomalydetector_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_ANOMALYDETECTOR_*
 * defines into file @ref anomalydetector.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_anomalydetector_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_ANOMALYDETECTOR_H */
